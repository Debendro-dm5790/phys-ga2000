...
def computeTimeStepandFHLL(deltaX, gamma, numInterfacePoints, u1, u2, u3):
    '''
    ...
    timeStepCandidate:        32-bit floating point number
                              ...
                              Courant-Friedrich-Levy condition. It is one-fifth of the 
    ...
    for i in range(numInterfacePoints):
        ...
        #print('Interface number ' + str(i))
        #print('u1[i], u2[i], and u3[i] are: ')
        #print(u1[i], u2[i], u3[i])
        #print('u1[i+1], u2[i+1], and u3[i+1] are: ')
        #print(u1[i+1], u2[i+1], u3[i+1])
        #print('Expressions inside the square root in speed of sound formula:')
        #print((u3[i]/u1[i]) - 0.5*(u2[i]**2/u1[i]**2))
        #print((u3[i+1]/u1[i+1]) - 0.5*(u2[i+1]**2/u1[i+1]**2))
        #print('LambdaPlusLeft = ' + str(lambdaPlusLeft))
        #print('LambdaPlusRight = ' + str(lambdaPlusRight))
        #print('LambdaMinusLeft = ' + str(lambdaMinusLeft))
        #print('LambdaMinusRight = ' + str(lambdaMinusRight))
        #print('alpha+ = ' + str(alphaPlus))
        #print('alpha- = ' + str(alphaMinus))
        #print('')
    ...
    timeStepCandidate = timeStepCandidate/5
