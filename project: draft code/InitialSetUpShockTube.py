...
Case 4: Number of spatial grid points is numPointsArray[3] = 700
'''
timeCounter = 0
...
MP.MakeFigure(x, d1, d2, d3, d4, d5, 'Position (meters)', 'Density (kg per cubic meter)', 'Densities Over Time for Grid Size = 200', [str(savedTimes[5]) + ' sec', str(savedTimes[6])+ ' sec', str(savedTimes[7])+ ' sec', str(savedTimes[8])+ ' sec', str(savedTimes[9])+ ' sec'], 'DensitiesGridSize=200.png')
...
MP.MakeFigure(x, v1, v2, v3, v4, v5, 'Position (meters)', 'Velocity (meters per second)', 'Velocities Over Time for Grid Size = 200', [str(savedTimes[5]) + ' sec', str(savedTimes[6])+ ' sec', str(savedTimes[7])+ ' sec', str(savedTimes[8])+ ' sec', str(savedTimes[9])+ ' sec'], 'VelocitiesGridSize=200.png')
...
MP.MakeFigure(x, P1, P2, P3, P4, P5, 'Position (meters)', 'Pressure (Pascal)', 'Pressures Over Time for Grid Size = 200', [str(savedTimes[5]) + ' sec', str(savedTimes[6])+ ' sec', str(savedTimes[7])+ ' sec', str(savedTimes[8])+ ' sec', str(savedTimes[9])+ ' sec'], 'PressuresGridSize=200.png')
...
MP.MakeFigure(x, d1, d2, d3, d4, d5, 'Position (meters)', 'Density (kg per cubic meter)', 'Densities Over Time for Grid Size = 400', [str(savedTimes[10]) + ' sec', str(savedTimes[11])+ ' sec', str(savedTimes[12])+ ' sec', str(savedTimes[13])+ ' sec', str(savedTimes[14])+ ' sec'], 'DensitiesGridSize=400.png')
...
MP.MakeFigure(x, v1, v2, v3, v4, v5, 'Position (meters)', 'Velocity (meters per second)', 'Velocities Over Time for Grid Size = 400', [str(savedTimes[10]) + ' sec', str(savedTimes[11])+ ' sec', str(savedTimes[12])+ ' sec', str(savedTimes[13])+ ' sec', str(savedTimes[14])+ ' sec'], 'VelocitiesGridSize=400.png')
...
MP.MakeFigure(x, P1, P2, P3, P4, P5, 'Position (meters)', 'Pressure (Pascal)', 'Pressures Over Time for Grid Size = 400', [str(savedTimes[10]) + ' sec', str(savedTimes[11])+ ' sec', str(savedTimes[12])+ ' sec', str(savedTimes[13])+ ' sec', str(savedTimes[14])+ ' sec'], 'PressuresGridSize=400.png')
