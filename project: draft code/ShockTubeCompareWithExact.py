...
MP.MakeFigure(x, d1, d2, d3, d4, d5, 'Position (cm)', 'Density (grams per cubic centimeter)', 'Densities Over Time for Grid Size = 700', [str(savedTimes[0]) + ' sec', str(savedTimes[1]) + ' sec', str(savedTimes[2]) + ' sec', str(savedTimes[3]) + ' sec', str(savedTimes[4]) + ' sec'], 'DensitiesGridSize=700.png')
...
MP.MakeFigure(x, v1, v2, v3, v4, v5, 'Position (cm)', 'Velocity (centimeters per second)', 'Velocities Over Time for Grid Size = 700', [str(savedTimes[0]) + ' sec', str(savedTimes[1]) + ' sec', str(savedTimes[2]) + ' sec', str(savedTimes[3]) + ' sec', str(savedTimes[4]) + ' sec'], 'VelocitiesGridSize=700.png')
...
MP.MakeFigure(x, P1, P2, P3, P4, P5, 'Position (cm)', 'Pressure (ergs per cubic centimeter)', 'Pressures Over Time for Grid Size = 700', [str(savedTimes[0]) + ' sec', str(savedTimes[1]) + ' sec', str(savedTimes[2]) + ' sec', str(savedTimes[3]) + ' sec', str(savedTimes[4]) + ' sec'], 'PressuresGridSize=700.png')
