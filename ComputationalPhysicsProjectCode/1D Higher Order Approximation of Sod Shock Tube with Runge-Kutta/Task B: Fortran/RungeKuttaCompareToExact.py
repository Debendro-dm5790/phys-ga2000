...
MP.MakeFigure4(xList,np.array(d1, dtype = np.float32) - rho1,'Position (cm)', 'Density Residuals (grams per cubic centimeter)', 'Density Residuals at Time ' + str(time1) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxDensityResTime='+str(time1)+'.png')
MP.MakeFigure4(xList,np.array(d2, dtype = np.float32) - rho2,'Position (cm)', 'Density Residuals (grams per cubic centimeter)', 'Density Residuals at Time ' + str(time2) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxDensityResTime='+str(time2)+'.png')
MP.MakeFigure4(xList,np.array(d3, dtype = np.float32) - rho3,'Position (cm)', 'Density Residuals (grams per cubic centimeter)', 'Density Residuals at Time ' + str(time3) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxDensityResTime='+str(time3)+'.png')
MP.MakeFigure4(xList,np.array(d4, dtype = np.float32) - rho4,'Position (cm)', 'Density Residuals (grams per cubic centimeter)', 'Density Residuals at Time ' + str(time4) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxDensityResTime='+str(time4)+'.png')
MP.MakeFigure4(xList,np.array(d5, dtype = np.float32) - rho5,'Position (cm)', 'Density Residuals (grams per cubic centimeter)', 'Density Residuals at Time ' + str(time5) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxDensityResTime='+str(time5)+'.png')

MP.MakeFigure4(xList,np.array(v1, dtype = np.float32) - vel1,'Position (cm)', 'Velocity Residuals (centimeters per second)', 'Velocity Residuals at Time ' + str(time1) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxVelocityResTime='+str(time1)+'.png')
MP.MakeFigure4(xList,np.array(v2, dtype = np.float32) - vel2,'Position (cm)', 'Velocity Residuals (centimeters per second)', 'Velocity Residuals at Time ' + str(time2) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxVelocityResTime='+str(time2)+'.png')
MP.MakeFigure4(xList,np.array(v3, dtype = np.float32) - vel3,'Position (cm)', 'Velocity Residuals (centimeters per second)', 'Velocity Residuals at Time ' + str(time3) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxVelocityResTime='+str(time3)+'.png')
MP.MakeFigure4(xList,np.array(v4, dtype = np.float32) - vel4,'Position (cm)', 'Velocity Residuals (centimeters per second)', 'Velocity Residuals at Time ' + str(time4) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxVelocityResTime='+str(time4)+'.png')
MP.MakeFigure4(xList,np.array(v5, dtype = np.float32) - vel5,'Position (cm)', 'Velocity Residuals (centimeters per second)', 'Velocity Residuals at Time ' + str(time5) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxVelocityResTime='+str(time5)+'.png')

MP.MakeFigure4(xList,np.array(P1, dtype = np.float32) - press1,'Position (cm)', 'Pressure Residuals (ergs per cubic centimeter)', 'Pressure Residuals at Time ' + str(time1) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxPressureResTime='+str(time1)+'.png')
MP.MakeFigure4(xList,np.array(P2, dtype = np.float32) - press2,'Position (cm)', 'Pressure Residuals (ergs per cubic centimeter)', 'Pressure Residuals at Time ' + str(time2) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxPressureResTime='+str(time2)+'.png')
MP.MakeFigure4(xList,np.array(P3, dtype = np.float32) - press3,'Position (cm)', 'Pressure Residuals (ergs per cubic centimeter)', 'Pressure Residuals at Time ' + str(time3) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxPressureResTime='+str(time3)+'.png')
MP.MakeFigure4(xList,np.array(P4, dtype = np.float32) - press4,'Position (cm)', 'Pressure Residuals (ergs per cubic centimeter)', 'Pressure Residuals at Time ' + str(time4) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxPressureResTime='+str(time4)+'.png')
MP.MakeFigure4(xList,np.array(P5, dtype = np.float32) - press5,'Position (cm)', 'Pressure Residuals (ergs per cubic centimeter)', 'Pressure Residuals at Time ' + str(time5) + ' sec', ['RK Approximate - Fortran Exact'], 'FortranRKApproxPressureResTime='+str(time5)+'.png')
