...
MP.MakeFigure3(savedTimes, timesForLowerOrder[0:numOfSavedTimes], timesForHigherOrder[0:numOfSavedTimes], 'Time Development Values (seconds)', 'Execution Time (seconds)', 'Comparing Execution Times For System Size = 100', ['Lower Order', 'Runge-Kutta'], 'TimeCompareSize=100.png')
MP.MakeFigure3(savedTimes, timesForLowerOrder[numOfSavedTimes:2*numOfSavedTimes], timesForHigherOrder[numOfSavedTimes:2*numOfSavedTimes], 'Time Development Values (seconds)', 'Execution Time (seconds)', 'Comparing Execution Times For System Size = 200', ['Lower Order', 'Runge-Kutta'], 'TimeCompareSize=200.png')
MP.MakeFigure3(savedTimes, timesForLowerOrder[2*numOfSavedTimes:3*numOfSavedTimes], timesForHigherOrder[2*numOfSavedTimes:3*numOfSavedTimes], 'Time Development Values (seconds)', 'Execution Time (seconds)', 'Comparing Execution Times For System Size = 400', ['Lower Order', 'Runge-Kutta'], 'TimeCompareSize=400.png')
