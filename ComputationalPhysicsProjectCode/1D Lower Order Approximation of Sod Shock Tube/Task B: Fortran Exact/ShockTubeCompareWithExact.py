...
MP.MakeFigure4(xList,(np.array(d1, dtype = np.float32) - rho1)/rho1,'Position (cm)', 'Density Residuals', 'Density Residuals at Time ' + str(time1) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonDensityResTime='+str(time1)+'.png', -2, 2)
MP.MakeFigure4(xList,(np.array(d2, dtype = np.float32) - rho2)/rho2,'Position (cm)', 'Density Residuals', 'Density Residuals at Time ' + str(time2) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonDensityResTime='+str(time2)+'.png', -1, 1)
MP.MakeFigure4(xList,(np.array(d3, dtype = np.float32) - rho3)/rho3,'Position (cm)', 'Density Residuals', 'Density Residuals at Time ' + str(time3) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonDensityResTime='+str(time3)+'.png',-0.4, 0.4)
MP.MakeFigure4(xList,(np.array(d4, dtype = np.float32) - rho4)/rho4,'Position (cm)', 'Density Residuals', 'Density Residuals at Time ' + str(time4) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonDensityResTime='+str(time4)+'.png', -1, 1)
MP.MakeFigure4(xList,(np.array(d5, dtype = np.float32) - rho5)/rho5,'Position (cm)', 'Density Residuals', 'Density Residuals at Time ' + str(time5) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonDensityResTime='+str(time5)+'.png', -0.75, 0.75)

MP.MakeFigure4(xList,(np.array(v1, dtype = np.float32) - vel1)/vel1,'Position (cm)', 'Velocity Residuals', 'Velocity Residuals at Time ' + str(time1) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonVelocityResTime='+str(time1)+'.png', -2, 2)
MP.MakeFigure4(xList,(np.array(v2, dtype = np.float32) - vel2)/vel2,'Position (cm)', 'Velocity Residuals', 'Velocity Residuals at Time ' + str(time2) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonVelocityResTime='+str(time2)+'.png', -2, 2)
MP.MakeFigure4(xList,(np.array(v3, dtype = np.float32) - vel3)/vel3,'Position (cm)', 'Velocity Residuals', 'Velocity Residuals at Time ' + str(time3) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonVelocityResTime='+str(time3)+'.png', -2, 2)
MP.MakeFigure4(xList,(np.array(v4, dtype = np.float32) - vel4)/vel4,'Position (cm)', 'Velocity Residuals', 'Velocity Residuals at Time ' + str(time4) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonVelocityResTime='+str(time4)+'.png', -2, 2)
MP.MakeFigure4(xList,(np.array(v5, dtype = np.float32) - vel5)/vel5,'Position (cm)', 'Velocity Residuals', 'Velocity Residuals at Time ' + str(time5) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonVelocityResTime='+str(time5)+'.png', -2, 2)

MP.MakeFigure4(xList,(np.array(P1, dtype = np.float32) - press1)/press1,'Position (cm)', 'Pressure Residuals', 'Pressure Residuals at Time ' + str(time1) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonPressureResTime='+str(time1)+'.png', -2, 2)
MP.MakeFigure4(xList,(np.array(P2, dtype = np.float32) - press2)/press2,'Position (cm)', 'Pressure Residuals', 'Pressure Residuals at Time ' + str(time2) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonPressureResTime='+str(time2)+'.png', -2, 2)
MP.MakeFigure4(xList,(np.array(P3, dtype = np.float32) - press3)/press3,'Position (cm)', 'Pressure Residuals', 'Pressure Residuals at Time ' + str(time3) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonPressureResTime='+str(time3)+'.png', -1, 1)
MP.MakeFigure4(xList,(np.array(P4, dtype = np.float32) - press4)/press4,'Position (cm)', 'Pressure Residuals', 'Pressure Residuals at Time ' + str(time4) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonPressureResTime='+str(time4)+'.png', -2, 2)
MP.MakeFigure4(xList,(np.array(P5, dtype = np.float32) - press5)/press5,'Position (cm)', 'Pressure Residuals', 'Pressure Residuals at Time ' + str(time5) + ' sec', ['(Python Approximate - Fortran Exact)/(Fortran)'], 'FortranPythonPressureResTime='+str(time5)+'.png', -2, 2)
